...
{ 
    ...
    /** 
     * Generate Candidate Facebook login url for web 
     * 
     * @return  string 
     */ 
    ...
    /** 
     * Generate Candidate Facebook logout url for web 
     * 
     * @return string 
     */ 
    ...
    /** 
     * Generate Recruiter Facebook login url for web
     * 
     * @return  string 
     */ 
    public function employer_login_url(){ 
        // Login type must be web, else return empty string 
        if($this->config->item('facebook_login_type') != 'web'){ 
            return ''; 
        } 
        ...
        // Get login url 
        return $this->helper->getLoginUrl( 
            base_url() . $this->config->item('employer_facebook_login_redirect_url'), 
            $this->config->item('facebook_permissions') 
        ); 
    }
    
    /** 
     * Generate Recruiter Facebook logout url for web
     * 
     * @return string 
     */ 
    public function employer_logout_url(){ 
        // Login type must be web, else return empty string 
        if($this->config->item('facebook_login_type') != 'web'){ 
            return ''; 
        } 
        ...
        return $this->helper->getLogoutUrl( 
            $this->get_access_token(), 
            base_url() . $this->config->item('employer_facebook_logout_redirect_url') 
        ); 
    } 
