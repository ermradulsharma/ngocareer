...
<section class="content-header">
    <h1>Event  <small>Payment</small> </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo site_url(Backend_URL) ?>"><i class="fa fa-dashboard"></i> Admin</a></li>
        <li><a href="<?php echo site_url(Backend_URL . 'job') ?>">Event</a></li>
...
<section class="content">
    <?php echo eventTabs($id, 'payment_form'); ?>
...
<script type="text/javascript">
    ...
    function stripeResponseHandler(status, response) {
        ...
        if (response.error) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/event/make_payment'); ?>',
                type: "post",
