...
<section class="content-header">
    <h1>Skill<small><?php echo $button ?></small></h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo Backend_URL ?>"><i class="fa fa-dashboard"></i> Admin</a></li>
        <li><a href="<?php echo Backend_URL ?>job">Job</a></li>
        <li><a href="<?php echo Backend_URL ?>job/skill">Skill</a></li>
            ...
            <form class="form-horizontal" action="<?php echo $action; ?>" method="post">
                ...
                <div class="form-group">
                    <div class="col-md-10 col-md-offset-2">
                        ...
                        <a href="<?php echo site_url(Backend_URL . 'job/skill') ?>" class="btn btn-default">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
