                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="name">Slide Name</label>
                            <div class="col-md-10">
                                <input type="text" value="<?php echo $title; ?>" class="form-control" name="title" id="title" placeholder="Title/Heading" />
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="content">Slide Name</label>
                            <div class="col-md-10">
                                <textarea name="content"  value="<?php echo $content; ?>" rows="8" class="form-control" id="content" placeholder="Caption"></textarea>                                
                            </div>
                        </div>
                    ...
                    <div class="col-md-6"> 
                        <input type="hidden" name="old_slide" value="<?php echo $thumb; ?>"/>
                        <div class="thumbnail upload_image">                     
                            <img src="<?php echo getSliderPhoto($thumb); ?>">
                        </div>
