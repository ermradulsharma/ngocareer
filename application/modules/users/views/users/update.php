        ...
        <div class="col-md-12">               
            ...
            <div class="box no-border">
                <div class="box-body">
                    ...
                    <form method="post" action="<?php echo $action; ?>" name="update"  class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="role_id" class="form-control" id="role_id" onchange="roleChange();">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label for="add_line1" class="col-sm-4 control-label">Address Line1</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="add_line2" class="col-sm-4 control-label">Address Line2</label>
                                    <div class="col-sm-6">
