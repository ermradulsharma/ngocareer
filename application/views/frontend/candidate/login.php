...
<div class="container">
    <h1>Sign in to your Candidate account</h1>
            ...
            <div id="logreg-forms">
                ...
                <form class="form-signin" id="credential" action="<?php echo base_url('auth/login'); ?>" <?php echo $loginFormStyle; ?>>
                    ...
                    <div class="social-login">
                        <a href="<?php echo $authURL; ?>"><button class="btn facebook-btn social-btn" type="button"><span><i class="fa fa-facebook-f"></i> Sign in with Facebook</span> </button></a>
                        <a href="<?php echo $googleLoginURL; ?>" ><button class="btn google-btn social-btn" type="button"><span><i class="fa fa fa-google"></i> Sign in with Gmail</span> </button></a>
                    </div>
